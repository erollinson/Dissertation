...
For all blocked analyses, use column "Block" for the horizontal blocks (original) and "NewBlock" for the vertical blocks (new/revision) - yet to be reclassified for the survival analysis dataframe
```{r}
require(survival)
...
#overall significance of models does not chance with or without blocking
...
For all blocked analyses, use column "Block" for the horizontal blocks (original) and "NewBlock" for the vertical blocks (new/revision)
...
null<-(lme(Height ~ 1, random = ~1|Block, data=gpope))
anova(null, lmgpope)

null<-(lme(Height ~ 1, random = ~1|Block, data=gprvu))
anova(null, lmgprvu)

null<-(lme(Height ~ 1, random = ~1|Block, data=gsofl))
anova(null, lmgsofl)

null<-(lme(Height ~ 1, random = ~1|Block, data=gpovi))
anova(null, lmgpovi)

null<-(lme(Height ~ 1, random = ~1|Block, data=gmavu))
anova(null, lmgmavu)

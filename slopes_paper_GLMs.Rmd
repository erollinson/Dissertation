...
```{r}
#greenlines
gl<-specaccum(matrix[1:761, 3:247], method="random", permutations = 999, conditioned = TRUE)
#upslope
up<-specaccum(matrix[762:1542, 3:247], method="random", permutations = 999, conditioned = TRUE)

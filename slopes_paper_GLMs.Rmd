...
summary(rich2)
display(rich1)
model.matrix(rich2) #use this on the model of interest (rich1, rich2, etc - to look at all the comparisons in the model matrix and confirm what contrasts go with which somewhat-obscure name in the summary)
...
nrich0<-glm(CountNatSp ~ 0, family="quasipoisson", offset=log(Area), data=data)
nrich1<-glm(CountNatSp ~ -1 + River/Site, family="quasipoisson", offset=log(Area), data=data)
nrich2<-glm(CountNatSp ~ -1 + River/Site/Bank, family="quasipoisson", offset=log(Area), data=data)
display(nrich0)
display(nrich1)
display(nrich2)
anova(nrich1,nrich2, test="Chisq")
...
irich0<-glm(CountInvSp ~ 0, family="quasipoisson", offset=log(Area), data=data)
irich1<-glm(CountInvSp ~ -1 + River/Site, family="quasipoisson", offset=log(Area), data=data)
irich2<-glm(CountInvSp ~ -1 + River/Site/Bank, family="quasipoisson", offset=log(Area), data=data)
display(irich0)
display(irich1)
display(irich2)
summary (irich2)
...
ct0<-glm(CountInd ~ 0, family="quasipoisson", offset=log(Area), data=data)
ct1<-glm(CountInd ~ -1 + River/Site, family="quasipoisson", offset=log(Area), data=data)
ct2<-glm(CountInd ~ -1 + River/Site/Bank, family="quasipoisson", offset=log(Area), data=data)
display(ct0)
display(ct1)
display(ct2)
summary(ct2)
...
nct0<-glm(CountNatInd ~ 0, family="quasipoisson", offset=log(Area), data=data)
nct1<-glm(CountNatInd ~ -1 + River/Site, family="quasipoisson", offset=log(Area), data=data)
nct2<-glm(CountNatInd ~ -1 + River/Site/Bank, family="quasipoisson", offset=log(Area), data=data)
display(nct0)
display(nct1)
display(nct2)
anova(nct1, nct2, test="Chisq")
...
ict0<-glm(CountInvInd ~ 0, family="quasipoisson", offset=log(Area), data=data)
ict1<-glm(CountInvInd ~ -1 + River/Site, family="quasipoisson", offset=log(Area), data=data)
ict2<-glm(CountInvInd ~ -1 + River/Site/Bank, family="quasipoisson", offset=log(Area), data=data)
display(ict0)
display(ict1)
display(ict2)
summary(ict2)
...
cov0<-glm(HerbCov ~ 0, family="quasibinomial", data=data)
cov1<-glm(HerbCov ~ -1 + River/Site, family="quasibinomial", data=data)
cov2<-glm(HerbCov ~ -1 + River/Site/Bank, family="quasibinomial", data=data)
display(cov0)
display(cov1)
display(cov2)
anova(cov1, cov2, test="Chisq")
...
ncov0<-glm(NatHerbCov ~ 0, family="quasibinomial", data=data)
ncov1<-glm(NatHerbCov ~ -1 + River/Site, family="quasibinomial", data=data)
ncov2<-glm(NatHerbCov ~ -1 + River/Site/Bank, family="quasibinomial", data=data)
display(ncov0)
display(ncov1)
display(ncov2)
anova(ncov1, ncov2, test="Chisq")
...
icov0<-glm(InvHerbCov ~ 0, family="quasibinomial", data=data)
icov1<-glm(InvHerbCov ~ -1 + River/Site, family="quasibinomial", data=data)
icov2<-glm(InvHerbCov ~ -1 + River/Site/Bank, family="quasibinomial", data=data)
display(icov0)
display(icov1)
display(icov2)
anova(icov1, icov2, test="Chisq")
...
Figures with the new standard errors from the GLM

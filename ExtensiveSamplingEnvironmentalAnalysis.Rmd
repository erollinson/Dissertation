...
Yet another set of preferred environmental variables and the corresponding CCA
...
summary(prefcca)
bioenv(comm,prefenv, upto=6)
plot(prefcca)

#this gives crosses for speies and circles for the sites
```
...
#use the pres/abs matrix for 2013 as 'matrix'
...
rep=99
nsites=53
permFEve<-matrix(nrow=rep, ncol=nsites)
permFDiv<-matrix(nrow=rep, ncol=nsites)
permFDis<-matrix(nrow=rep, ncol=nsites)
permRaoQ<-matrix(nrow=rep, ncol=nsites)
for (i in 1:rep) {
...
add elevation remove longitude

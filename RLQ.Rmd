...
modelenv<-dudi.hillsmith(env, row.w = modelsp$lw)
...
nrepet = 9999
fourth<-fourthcorner(env, species, traits, modeltype=6, , p.adjust.method.G="fdr", p.adjust.method.D="fdr", nrepet = nrepet) 
...
s.arrow(rlq1$l1) #l1 = arrows for environment
s.arrow(rlq1$c1) # c1 = arrows for traits
...
Srlq$trRLQ #returns the total inertial of the RLQ analysis

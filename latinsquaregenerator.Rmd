---
title: "Function for generating latin squares"
author: "R Cookbook"
date: "Wednesday, November 19, 2014"
output: html_document
---

Taken from http://www.cookbook-r.com/Tools_for_experiments/Generating_counterbalanced_orders/ on 11/19/2014

Generate latin square (need to define the function first using the next box below)

```{r}
latinsquare(4)
```

This code defines the function for generating latin squares
```{r}
...
## -returnstrings tells it to return a vector of char strings for each square, instead of a big matrix.
##     This option is only really used for checking the randomness of the squares.

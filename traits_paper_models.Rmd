...
names(alltraits2)[names(alltraits2)=="LeafCN"] <-"leafCN" #ddply doesn't seem to like spaces in column names, or ""ing them
...
ggplot(cphot, aes(x=Origin, y=mean)) + geom_bar(position=position_dodge(), stat="identity") + geom_errorbar(aes(ymin=mean-se, ymax = mean+se), width=.2) + theme_bw() + theme (panel.grid.majo                                                                                                                                                                                                                                                                                                                        r=element_line(color = NA), panel.grid.minor=element_line(color = NA))+ ylab("Photosynthesis (nmol CO2 per g dry leaf per s)")
...
cseedno$Origin<-factor(cseedno$Origin, levels=c("N", "I"))

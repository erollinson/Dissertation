...
ggplot(clwr, aes(x=Origin, y=mean)) + geom_point(position=position_dodge(), stat="identity", size=4) + geom_errorbar(aes(ymin=mean-se, ymax = mean+se), width=.2) + theme_bw() + theme (panel.grid.major=element_line(color = NA), panel.grid.minor=element_line(color = NA), text=element_text(size=20))+ ylab("LWR")
...
ggplot(cseedno, aes(x=Origin, y=log(mean,10))) + geom_point(position=position_dodge(), stat="identity", size=4) + geom_errorbar(aes(ymin=log(mean-se,10), ymax = log(mean+se,10), width=.2)) + theme_bw() + theme (panel.grid.major=element_line(color = NA), panel.grid.minor=element_line(color = NA), text=element_text(size=20))+ ylab("log(Number of seeds per reproductive unit)")
